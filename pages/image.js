              ...
              <Input variant={"solid"} placeholder="Enter your creative prompt" value={prompt} onChange={(e)=>setPrompt(e.target.value)}></Input>
                ...
                <Slider w="100%" colorScheme='black' aria-label='painter slider' defaultValue={12} min={4} max={30} onChange={(value)=>setBrushRadius(value)}>
                    ...
                    <Menu>
                          ...
                          <MenuList >
                            <MenuItem>
                                <TwitterShareButton  url= 'https://google.com' title={`I created this with Data Without Limits using a NASA database! Credit to ${data.credit === "" ? "NASA" : data.credit}`}>
                                  <HStack>
                                    <TwitterIcon size={36}/>
                                    <Text>Twitter</Text>
                                    </HStack>
                            ...
                            <MenuItem>
                              <FacebookShareButton url= 'https://google.com' title={`I created this with Data Without Limits using a NASA database! Credit to ${data.credit}`}>
                                <HStack  pl={3} w="100%">
